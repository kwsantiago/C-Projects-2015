...
int main(){
    ...
    {
        cout << "2015 is a great year for Taurus to begin something new and maybe choose a new direction for some part of your life. Mentally, you may have been preparing, and now's the time. The Sun and Moon are both in Taurus as your year starts, so April and May could be the most agreeable for your plans. Love and relationships in general may take a slight hit in July and August when Venus goes retrograde from July 25 until September 6. Sometimes you need to go extra slow with people and affairs of the heart, that's all. Be extra creative and you'll be popular all summer long. The Mercury retrograde in Libra (September 17 to October 9) might stress relationships, but Venus rules here, too, and Taurus knows how to be sweet. Be healthy, happy, and good to yourself, especially in November and December!\n";
        system("PAUSE");
    }
    //Taurus
    ...
    {
        cout << "You have a well-balanced year ahead, Leo, with plenty of passionate Fire, sensitive Water, practical Earth, and diplomatic Air energies at your fingertips. Neptune will offer you illusions and comfortable escapes in February. Uranus will surprise and energize you in April. Mercury and Mars will tug at your heartstrings and family in July. Venus will make daily life more pleasant and comfortable than ever in September. What a year! Jupiter spends the first half of 2015 in your sign, Leo, bringing good luck and abundance, but also the temptation to enjoy the good things in life in excess. Try to use moderation in all things, especially eating, spending, and socializing, and simply share the wealth. Jupiter is retrograde until April 8, so be aware of maintaining or improving your personal integrity. Energy might sag and minor health concerns could become a concern in November, when the Sun (the ruler of Leo) encounters Saturn. Balance and good sense can fix all. Take good care of yourself and enjoy each day to its fullest!\n";
        system("PAUSE");
    }
    //Leo
